...
| マーケット cockpit | ガード付き取引ワークスペース |
|---|---|
| ![agent-finance TUI マーケット cockpit と OHLCV チャート](assets/tui-market-cockpit.png) | ![agent-finance TUI ガード付き取引ワークスペース](assets/tui-trade-workspace.png) |
